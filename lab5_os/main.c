...
{
    sleep(rand() % 5);
    int sem_op_p = semop(semid, producer_start, 2); // производит операции над выбранными элементами из набора семафоров semid
    if (sem_op_p == -1)
    {
